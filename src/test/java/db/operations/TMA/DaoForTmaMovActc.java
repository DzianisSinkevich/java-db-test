...
public class DaoForTmaMovActc extends ADao<TmaMovActc> {
	...
	private static final String S22_1 = "insert into tmp3_tma_mov_actc select * from  bak2_tma_mov_actc  where SV_INTERNAL_ID = '3227084'";
	private static final String S22_2 = "update tmp3_tma_mov_actc set C0DLCIE3 = '220444' where CMAQNMOV = '1823343'";
	private static final String S22_3 = "update tmp3_tma_mov_actc set cmalcsbc = '0444' where CMAQNMOV = '1823343'";
	private static final String S22_4 = "update tmp3_tma_mov_actc set CMAQSERE = '160401' where CMAQNMOV = '1823343'";
	private static final String S22_5 = "update tmp3_tma_mov_actc set  CMALCOME = '1' where CMAQNMOV = '1823343'";
	private static final String S22_6 = "update tmp3_tma_mov_actc set  CMAMP29B = '1' where CMAQNMOV = '1823343'";
	private static final String S22_7 = "update tmp3_tma_mov_actc set  CMAVNAUT = '540193' where CMAQNMOV = '1823343'";
	private static final String S22_8 = "update tmp3_tma_mov_actc set  CMAMNAUT = '1' where CMAQNMOV = '1823343'";
	private static final String S22_9 = "insert into tma_mov_actc select * from  tmp3_tma_mov_actc  where CMAQNMOV = '1823343'";
	private static final String S22_10 = "update tma_mov_actc set sv_internal_id = null where CMAQNMOV = '1823343'";
	private static final String S22_11 = "update tma_mov_actc set is_new_field = 1 where CMAQNMOV = '1823343'";
	private static final String S22_12 = "insert into tmp3_TMT_MOV_ACCT select * from  bak2_TMT_MOV_ACCT where CMtQNMOV = '84347730'";
	private static final String S22_13 = "insert into tmp3_TMT_MOV_ACCT select * from  bak2_TMT_MOV_ACCT where CMtQNMOV = '111144143'";
	private static final String S22_14 = "update tmp3_TMT_MOV_ACCT set C0DLCIE1 = '220444' where CMtQNMOV = '84347730'";
	private static final String S22_15 = "update tmp3_TMT_MOV_ACCT set cmtqsead = '160401' where CMtQNMOV = '84347730'";
	private static final String S22_16 = "update tmp3_TMT_MOV_ACCT set cp0lappl  ='22' where CMtQNMOV = '84347730'";
	private static final String S22_17 = "update tmp3_TMT_MOV_ACCT set C0DLCIE1 = '220444' where CMtQNMOV = '111144143'";
	private static final String S22_18 = "update tmp3_TMT_MOV_ACCT set cmtqsead = '160401' where CMtQNMOV = '111144143'";
	private static final String S22_19 = "update tmp3_TMT_MOV_ACCT set cp0lappl  ='22' where CMtQNMOV = '111144143'";
	private static final String S22_20 = "insert into TMT_MOV_ACCT select * from  tmp3_TMT_MOV_ACCT  where CMtQNMOV = '84347730'";
	private static final String S22_21 = "insert into TMT_MOV_ACCT select * from  tmp3_TMT_MOV_ACCT  where CMtQNMOV = '111144143'";
	private static final String S22_22 = "update TMT_MOV_ACCT set sv_internal_id = null  where CMtQNMOV = '84347730'";
	private static final String S22_23 = "update TMT_MOV_ACCT set is_new_field = 1 where CMtQNMOV = '84347730'";
	private static final String S22_24 = "update TMT_MOV_ACCT set sv_internal_id = null  where CMtQNMOV = '111144143'";
	private static final String S22_25 = "update TMT_MOV_ACCT set is_new_field = 1 where CMtQNMOV = '111144143'";
	private static final String TMAMOVACTC_OPEN_SESSION_22 = "insert into tmp3_tma_mov_actc (cMAPALTA, C0DLCIE3, cmalcsbc, CMAQSERE, CMALCOME, CMAMP29B, CMAVNAUT, CMAMNAUT, IS_NEW_FIELD, CMAQNMOV) VALUES ('15-JAN-08 01.51.13.864000000 PM', 220444, 0444, 160401, 1, '1', '540193', '1', 1, 90000000)";
	
	public PreparedStatement getTmaDataClear() {
		String qs = TMADATA_DELETE;
		try {
			ps = Connector.getInstance().getConnTMA().prepareStatement(qs);
			ps.executeUpdate();
	...
	public PreparedStatement getOpenSession22() {
		String qs = TMAMOVACTC_OPEN_SESSION_22;
		try {
			ps = Connector.getInstance().getConnTMA().prepareStatement(qs);
			ps.executeUpdate();
		} catch (SQLException e) {
